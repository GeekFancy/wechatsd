...
const getSubscribeMessage = (openUserId) => {
  ...
  // `;
  return `Welcome1234! This is the WeChat official account of SAP S/4HANA Sales for testing.
  
In this WeChat official account, you can manage your sales orders. You will also receive a WeChat notification when, for example, you successfully created a sales order here.

Before exploring and making full use of this services, you need to <a href="${getSigninUrl(openUserId)}">authorize your SAP account</a>.
  `;
};
